...
- [x] T002 [FR-23/FR-24/FR-26/SC-11] Create npm package metadata in `package.json`, `package-lock.json`, `bin/deploy-config-schema.js`, and `.npmrc` using the short coordinate `@jorisjonkers-dev/deploy-config-schema`.
...
- [x] T012 [FR-23/FR-26] Update `.github/workflows/ci.yml`, add `.github/workflows/release.yml`, and add release-please manifests.
