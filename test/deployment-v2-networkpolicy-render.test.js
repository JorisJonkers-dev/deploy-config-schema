...
import { renderNetworkPolicies } from "../src/deployment-v2/render/networkpolicy.js";
...
test("deploy-v2 NetworkPolicy parity mode emits only imported policies", () => {
  const imported = {
...
test("deploy-v2 NetworkPolicy v2 mode derives edge and provider policies without default deny", () => {
