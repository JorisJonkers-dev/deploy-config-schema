...
import { applyEnvironment, deepMerge, loadEnvironmentFiles } from "../src/deployment/env.js";
import { loadYamlDocument } from "../src/deployment/io.js";

test("loadEnvironmentFiles applies runtime before selected environment", () => {
  const base = loadYamlDocument("fixtures/deployment/deployment.yml");
  const envFiles = loadEnvironmentFiles({
    deploymentPath: "fixtures/deployment/deployment.yml",
